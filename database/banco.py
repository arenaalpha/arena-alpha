...
def _criar_postgres():
    tabelas = (
        ...
        "CREATE TABLE IF NOT EXISTS comissoes_professores (id SERIAL PRIMARY KEY,professor_id INTEGER NOT NULL,pagamento_id INTEGER NOT NULL,valor REAL NOT NULL,mes TEXT NOT NULL,status TEXT NOT NULL DEFAULT 'Pago',pago_em TEXT,UNIQUE(professor_id,pagamento_id))",
...
def _criar_sqlite():
    tabelas = (
        ...
        "CREATE TABLE IF NOT EXISTS comissoes_professores (id INTEGER PRIMARY KEY AUTOINCREMENT,professor_id INTEGER NOT NULL,pagamento_id INTEGER NOT NULL,valor REAL NOT NULL,mes TEXT NOT NULL,status TEXT NOT NULL DEFAULT 'Pago',pago_em TEXT,UNIQUE(professor_id,pagamento_id))",
